$(document).ready(function() {
	...
	var form = doucument.getElementById('MemberForm');
	...
	function validate() {
		...
		if (!check2(YY, birthdayYY, label_birthday, '4자리로 입력해주세요')) {
			return false;
		}
		...
		if (!check2(DD, birthdayDD, label_birthday, '2자리로 입력해주세요')) {
			return false;
		}
