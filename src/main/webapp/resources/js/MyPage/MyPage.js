...
function updatePN_ok() {
	...
	//유효성 검증
	if(!check(PhoneNumberCode,user_id,PnUpdateInfo,PhoneNumber_input_DP,PhoneNumber_info_DP,"지원하지 않는 핸드폰 번호 입니다.")){
		return false;
	}
	
	//ajax 처리(비동기)
	UpdateMemberInfo(PhoneURL, user_id, PnUpdateInfo, PhoneNumber_info_DP, PhoneNumber_input_DP, ajaxMessage, ajaxMessage1);
