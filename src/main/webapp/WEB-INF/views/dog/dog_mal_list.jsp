                            ...
                            <ul class="tabs">
                                ...
                                <div id="cList_paging">
                                    ...
                                    <c:if test="${(empty find_field)&&(empty find_name)}">
                                        ...
                                        <c:if test="${page >1}">
                                            <a href="/dog/dog_mal_list?page=${page-1}">&lt;</a>&nbsp;
                                        </c:if>
                                        ...
                                        <c:forEach var="a" begin="${startpage}" end="${endpage}" step="1">
                                            ...
                                            <c:if test="${a != page}">
                                                <a href="/dog/dog_mal_list?page=${a}">${a}</a>&nbsp;
                                            </c:if>
                                        </c:forEach>
                                    ...
                                    <c:if test="${(!empty find_field) || (!empty find_name)}">
                                        ...
                                        <c:if test="${page >1}">
                                            <a
                                                href="/dog/dog_mal_list?page=${page-1}&find_field=${find_field}&find_name=${find_name}">
                                                &lt;</a>&nbsp;
                                        </c:if>
                                        ...
                                        <c:forEach var="a" begin="${startpage}" end="${endpage}" step="1">
                                            ...
                                            <c:if test="${a != page}">
                                                <a
                                                    href="/dog/dog_mal_list?page=${a}&find_field=${find_field}&find_name=${find_name}">
                                                    ${a}</a>&nbsp;
                                            </c:if>
                                        </c:forEach>
