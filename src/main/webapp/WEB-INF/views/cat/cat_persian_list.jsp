                    ...
                    <article class="column col1">
                        <div class="main">
                            ...
                            <ul class="tabs">
                            	...
                            	<li class="current"><a href="/cat/cat_persian_list?page=1">페르시안</a></li>
                            </ul>
                                ...
                                <div id="cList_paging">
                                    ...
                                    <c:if test="${(empty find_field)&&(empty find_name)}">
                                        ...
                                        <c:if test="${page >1}">
                                            <a href="cat/cat_persian_list?page=${page-1}">&lt;</a>&nbsp;
                                        </c:if>
                                        ...
                                        <c:forEach var="a" begin="${startpage}" end="${endpage}" step="1">
                                            ...
                                            <c:if test="${a != page}">
                                                <a href="/cat/cat_persian_list?page=${a}">${a}</a>&nbsp;
                                            </c:if>
                                        </c:forEach>
                                    ...
                                    <c:if test="${(!empty find_field) || (!empty find_name)}">
                                        ...
                                        <c:if test="${page >1}">
                                            <a
                                                href="/cat/cat_persian_list?page=${page-1}&find_field=${find_field}&find_name=${find_name}">
                                                &lt;</a>&nbsp;
                                        </c:if>
                                        ...
                                        <c:forEach var="a" begin="${startpage}" end="${endpage}" step="1">
                                            ...
                                            <c:if test="${a != page}">
                                                <a
                                                    href="/cat/cat_persian_list?page=${a}&find_field=${find_field}&find_name=${find_name}">
                                                    ${a}</a>&nbsp;
                                            </c:if>
                                        </c:forEach>
